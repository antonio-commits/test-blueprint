const automobileMock = {
  ...
  modello:
    'Et ut est rerum ratione tempora omnis. Est cupiditate aliquid beatae. Neque non iste. Voluptate debitis aut dolorum velit expedita laborum. Minima assumenda totam vel velit voluptatem blanditiis hic. Repudiandae animi eum esse suscipit non.',
};

export default automobileMock;
