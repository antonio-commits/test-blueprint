...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/automobile/formWidget/>):
   1. Run `npm i`
...
- **automobile.form.createError** (fired when an error occurs during automobile creation)
- **automobile.form.create** (fired when the automobile is successfully created)
- **automobile.form.updateError** (fired when an error occurs during automobile update)
- **automobile.form.update** (fired when the automobile is successfully updated)
