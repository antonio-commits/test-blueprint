...
const AutomobileTable = ({ items, onSelect, classes, t, Actions }) => {
  ...
  return items.length ? (
    ...
    <div className={classes.noItems}>{t('entities.automobile.noItems')}</div>
  );
};

AutomobileTable.propTypes = {
...
AutomobileTable.defaultProps = {
  onSelect: () => {},
  Actions: null,
};

export default withStyles(styles)(withTranslation()(AutomobileTable));
