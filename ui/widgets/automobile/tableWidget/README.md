...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/automobile/tableWidget/>):
   1. Run `npm i`
...
- **automobile.table.error** (fired when an error occurs)
- **automobile.table.select** (fired when a table row is selected)
