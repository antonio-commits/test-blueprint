...
class AutomobileDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'automobile.details.';
    ...
    const ReactComponent = React.createElement(AutomobileDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('automobile-details', AutomobileDetailsElement);
